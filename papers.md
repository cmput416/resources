...
- Johannes Späth, Karim Ali, and Eric Bodden. <a href="https://dl.acm.org/citation.cfm?id=3290361">Context-, Flow-, and Field-sensitive Data-Flow Analysis using Synchronized Pushdown Systems</a>, POPL '19.
- Neville Grech, George Fourtounis, Adrian Francalanza, and Yannis Smaragdakis. <a href="https://doi.org/10.1145/3133892">Heaps Don't Lie: Countering Unsoundness with Heap Snapshots</a>, OOPSLA '17.
- Rei Thiessen and Ondřej Lhoták. <a href="https://doi.org/10.1145/3062341.3062359">Context Transformations for Pointer Analysis</a>, PLDI '17.
- Olin Shivers. [Control Flow Analysis in Scheme](http://dx.doi.org/10.1145/53990.54007), PLDI '88.
- Frank Tip, Jens Palsberg. [Scalable Propagation-Based Call Graph Construction Algorithms](http://doi.acm.org/10.1145/353171.353190), OOPSLA '00.
- Karim Ali, Marianna Rapoport, Ondřej Lhoták, Julian Dolby, and Frank Tip. [Constructing Call Graphs of Scala Programs](http://dx.doi.org/10.1007/978-3-662-44202-9_3), ECOOP '14.
- Karim Ali and Ondřej Lhoták. [Averroes: Whole-Program Analysis Without the Whole Program](http://dx.doi.org/10.1007/978-3-642-39038-8_16), ECOOP '13.
- Ondřej Lhoták and Laurie Hendren. [Scaling Java Points-to Analysis Using Spark](https://doi.org/10.1007/3-540-36579-6_12), CC '03.

# IFDS & IDE
- Thomas W. Reps, Susan Horwitz, and Shmuel Sagiv. [Precise Interprocedural Dataflow Analysis via Graph Reachability](http://doi.acm.org/10.1145/199448.199462), POPL '95.
...
- Nomair A. Naeem, Ondřej Lhoták, and Jonathan Rodriguez. [Practical Extensions to the IFDS Algorithm](http://dx.doi.org/10.1007/978-3-642-11970-5_8), CC '10.
...
- Jens Dietrich, Nicholas Hollingum, and Bernhard Scholz. [Giga-Scale Exhaustive Points-To Analysis for Java in Under a Minute](http://dx.doi.org/10.1145/2814270.2814307), OOPSLA '15.
- Rohan Padhye and Uday P. Khedker. [Interprocedural Data Flow Analysis in Soot Using Value Contexts](http://dx.doi.org/10.1145/2487568.2487569), SOAP '13.
...
# Android
- Steven Arzt, Siegfried Rasthofer, Christian Fritz, Eric Bodden, Alexandre Bartel, Jacques Klein, Yves Le Traon, Damien Octeau, and Patrick McDaniel. [FlowDroid: Precise Context, Flow, Field, Object-sensitive and Lifecycle-aware Taint Analysis for Android Apps](http://doi.acm.org/10.1145/2594291.2594299), PLDI '14.
- Damien Octeau, Daniel Luchaup, Matthew Dering, Somesh Jha, and Patrick McDaniel. [Composite Constant Propagation: Application to Android Inter-Component Communication Analysis](http://dx.doi.org/10.1109/ICSE.2015.30), ICSE '15.
- Shengqian Yang, Dacong Yan, Haowei Wu, Yan Wang, and Atanas Rountev. [Static Control-Flow Analysis of User-Driven Callbacks in Android Applications](http://dx.doi.org/10.1109/ICSE.2015.31), ICSE '15.
- Lucas Brutschy, Pietro Ferrara, Omer Tripp, and Marco Pistoia. [ShamDroid: Gracefully Degrading Functionality in the Presence of Limited Resource Access](http://doi.acm.org/10.1145/2814270.2814296), OOPSLA '15.
- Pallavi Maiya, Aditya Kanade, and Rupak Majumdar. [Race Detection for Android Applications](https://doi.org/10.1145/2666356.2594311), PLDI '14.
- Jianjun Huang, Xiangyu Zhang, Lin Tan, Peng Wang, and Bin Liang. [AsDroid: Detecting Stealthy Behaviors in Android Applications by User Interface and Program Behavior Contradiction](https://doi.org/10.1145/2568225.2568301), ICSE '14.
...
- Shiyi Wei and Barbara Ryder. [Adaptive Context-sensitive Analysis for JavaScript](http://dx.doi.org/10.4230/LIPIcs.ECOOP.2015.712), ECOOP '15.

# Code Recommender Systems
- Reid Holmes, Gail C. Murphy. [Using Structural Context to Recommend Source Code Examples](https://doi.org/10.1109/ICSE.2005.1553554), ICSE '05.
- Sebastian Proksch, Johannes Lerch, Mira Mezini. [Intelligent Code Completion with Bayesian Networks](https://doi.org/10.1145/2744200), TOSEM '15.
...
- Sebastian Proksch, Sven Amann, Sarah Nadi, Mira Mezini. [Evaluating the Evaluations of Code Recommender Systems: A Reality Check](https://doi.org/10.1145/2970276.2970330), ASE '16.
- Marcel Bruch, Martin Monperrus, Mira Mezini. [Learning from Examples to Improve Code Completion Systems](https://doi.org/10.1145/1595696.1595728), FSE '09.
- Tihomir Gvero, Viktor Kuncak, Ivan Kuraj, Ruzica Piskac. [Complete Completion Using Types and Weights](https://doi.org/10.1145/2499370.2462192), PLDI '13.
...
- Hitesh Sajnani, Vaibhav Saini, Jeffrey Svajlenko, Chanchal K. Roy, Cristina V. Lopes. [SourcererCC: Scaling Code Clone Detection to Big-Code](https://doi.org/10.1145/2884781.2884877), ICSE '16.

# Program Synthesis
- Veselin Raychev, Pavol Bielik, Martin Vechev, Andreas Krause. [Learning Programs from Noisy Data](https://doi.org/10.1145/2837614.2837671), POPL '16.
- Kevin Ellis, Armando Solar-Lezama, and Joshua B. Tenenbaum. <a href="http://dl.acm.org/citation.cfm?id=2969239.2969348">Unsupervised Learning by Program Synthesis</a>, NIPS '15.

# Probabilistic Programming
- Di Wang, Jan Hoffmann, and Thomas W. Reps. <a href="https://doi.org/10.1145/3192366.3192408">PMAF: An Algebraic Framework for Static Analysis of Probabilistic Programs</a>, PLDI '18.
- Chung-Kil Hur, Aditya V. Nori, Sriram K. Rajamani, and Selva Samuel. [Slicing Probabilistic Programs](https://doi.org/10.1145/2666356.2594303), PLDI '14.
- Sriram Sankaranarayanan, Aleksandar Chakarov, and Sumit Gulwani. <a href="https://doi.org/10.1145/2499370.2462179">Static Analysis for Probabilistic Programs</a>, PLDI '13.

# Machine Learning
- Omer Katz, Ran El-Yaniv, and Eran Yahav. <a href="https://doi.org/10.1145/2914770.2837674">Estimating Types in Binaries using Predictive Modeling</a>, POPL '16.
- Vaseline Raychev, Martin Vechev, and Andreas Krause. [Predicting Program Properties from "Big Code"](https://doi.org/10.1145/2676726.2677009), POPL '15.

# Smart Contracts
- Shuai Wang, Chengyu Zhang, and Zhendong Su. <a href="https://doi.org/10.1145/3360615">Detecting Nondeterministic Payment Bugs in Ethereum Smart Contracts</a>, OOPSLA '19.
- Ilya Sergey, Vaivaswatha Nagaraj, Jacob Johannsen, Amrit Kumar, Anton Trunov, and Ken Chan Guan Hao. <a href="https://doi.org/10.1145/3360611">Safer Smart Contract Programming with Scilla</a>, OOPSLA '19.
- Neville Grech, Michael Kong, Anton Jurisevic, Lexi Brent, Bernhard Scholz, and Yannis Smaragdakis. <a href="https://doi.org/10.1145/3276486">MadMax: Surviving Out-of-Gas Conditions in Ethereum Smart Contracts</a>, OOPSLA '18.
